...
int findMaxOfDistractionFromGroupsOfPairsByDifference(
  const std::unordered_map<int, std::vector<IntPair>>& groupsOfPairs)
{
...
std::vector<IntPair>
findFirstTriplePossibleSolution(int x, int y, int c, const std::unordered_map<int, std::vector<IntPair>>& groupsOfPairs)
{
  // Get distinct pairs.
