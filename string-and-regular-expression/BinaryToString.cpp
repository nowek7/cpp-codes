...
std::string bytesToHexString(Iterator aBegin, Iterator aEnd, const bool aUppercase = false)
  {
...
template<typename C>
std::string bytesToHexString(const C &aSequence, const bool aUppercase = false)
  {
