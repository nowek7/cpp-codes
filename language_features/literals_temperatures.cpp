...
namespace
{
  bool areEqual(double aNumber, double aOther, double const aEpsilon = 0.001)
  {
...
namespace Temperature
{
  ...
  {
    static double convert(double aValue)
    {
  ...
  {
    constexpr Quantity<Scale::Celsius> operator"" _deg(long double aAmount)
    {
      return Quantity<Scale::Celsius>{static_cast<double>(aAmount)};
    }

    constexpr Quantity<Scale::Fahrenheit> operator"" _f(long double aAmount)
    {
      return Quantity<Scale::Fahrenheit>{static_cast<double>(aAmount)};
    }

    constexpr Quantity<Scale::Kelvin> operator"" _k(long double aAmount)
    {
