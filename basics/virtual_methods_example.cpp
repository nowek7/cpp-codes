...
namespace Core {
  auto isEqual(int aLeft, int aRight) -> bool
  {
    return aLeft == aRight;
  }

  auto isEqual(double aLeft, double aRight) -> bool
  {
    return aLeft == aRight;
  }

  auto isEqual(std::string aLeft, std::string aRight) -> bool
  {
