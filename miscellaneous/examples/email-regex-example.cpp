...
int main()
  ...
  ltest2(L"michal.nowak@domain.com"s);

  ltest3("michal.NOWAK@DOMAIN.COM"s);
  ltest3("michalNOWAK@DOMAIL.CO.UK"s);
  ltest3("michalNOWAK@DOMAIL.INFO"s);
  ltest3("M.I.C.H_A.L@DOMAIN.INFO"s);
  ltest3("ROOT@LOCALHOST"s);
  ltest3("michal.nowak@pucice.com"s);
  }